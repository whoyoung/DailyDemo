...
- (NSArray *)controllers {
    if (!_controllers) {
        _controllers = @[@"FindMaxAndMinNumberViewController",@"DrawViewController",@"LineChartViewController",@"HorizontalBarChartViewController",@"VerticalBarChartViewController",@"SemaphoreViewController"];
    }
    return _controllers;
}
